...
import {
  MainHeaderComponent, MainMenuComponent, SearchComponent, ErrorPageComponent,
...
@NgModule({
  ...
  exports: [MainHeaderComponent, PermissionDirective, BodyScrollDirective, OnlineOnlyDirective,
